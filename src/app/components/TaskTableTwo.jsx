...
function TaskTableInProgress() {
  ...
  return (
    <div className="bg-white p-6 rounded-xl shadow-md overflow-x-auto mt-5">
      <div className="flex justify-between items-center w-full bg-gray-100 p-2 mb-1 rounded-2xl h-[50px]">
        <div>
          <h3 className="text-gray-800 text-lg font-semibold ">In Progress</h3>
        </div>
...
export default TaskTableInProgress;